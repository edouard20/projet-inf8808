            ...
            <div className='container'>
                <div
                    className={`text-container ${
                        waffleTextInView ? 'in-view' : ''
                    }`}
                    ref={waffleTextRef}
                >
                    <div className='subtext'>
                        The visualization on the right shows the 6 nationalities
                        with more than 25 drivers.
                    </div>
                    <div className='subtext square'>
                        Every single cube is one F1 driver.
                        <div>
                            <Square />
                        </div>
                    </div>
                    <div className='subtext hover-text'>
                        Hover on the bars to see the exact driver count.
                    </div>
                    <div className='subtext' ref={waffleWinnersRef}>
